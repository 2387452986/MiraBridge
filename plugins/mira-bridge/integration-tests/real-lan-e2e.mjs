...
const expectedWorkerVersion = process.env.MIRABRIDGE_E2E_EXPECTED_WORKER ?? "2.0.0-rc.3";
const projectName = process.env.MIRABRIDGE_E2E_PROJECT ?? "MiraBridge-Release-Acceptance-2.0.0-rc.3";
...
async function connect() {
  ...
  const client = new Client({ name: "mirabridge-real-lan-e2e", version: "2.0.0-rc.3" });
