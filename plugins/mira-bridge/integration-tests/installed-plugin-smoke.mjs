...
const client = new Client({ name: "mirabridge-installed-plugin-smoke", version: "2.0.0-rc.3" });
...
try {
  ...
  if (described.worker_version !== "2.0.0-rc.3" || described.protocol_version !== "2.0") {
