...
function request(): PairingRequest {
  return {
    ...
    mac: { name: "test-mac", architecture: "arm64", mirabridge_version: "2.0.0-rc.5" },
  };
}
...
function response(value = request()): PairingResponse {
  return {
    ...
    windows: { hostname: "WINDOWS-NODE", architecture: "x64", user: "Administrator", mirabridge_version: "2.0.0-rc.5" },
