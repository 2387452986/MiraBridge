# MiraBridge 2.0.0-rc.6 architecture
...
MiraBridge is an independent `2.0.0-rc.6` release boundary. It does not register with or modify PAF/Mira's existing runtime MCP owner.
