# MiraBridge 2.0.0-rc.7 tool parity
...
The 2.0.0-rc.7 source exposes 28 MiraBridge tools. A new Codex task after plugin reinstall is the pickup boundary. Verification must inspect the new task rather than infer a total from older task-local registries.
