...
Security fixes target the latest `2.x` release candidate and, after stable release, the latest `2.x` stable line. The unsigned `2.0.0-rc.6` is for evaluation and is not a stable security baseline.
