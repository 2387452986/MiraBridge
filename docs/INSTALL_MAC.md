...
The user asks Codex to install the fixed `v2.0.0-rc.4` tag. Codex should:
...
`2387452986/MiraBridge` at the exact `v2.0.0-rc.4` ref using the official Codex
...
`mirabridge update 2.0.0-rc.4` downloads the exact tag archive and invokes the
